...
public class Map {
    ...
    private void createRooms() {
        ...
        room4 = new Room(4, "A very dark room, with two doors", "You are met with a deep darkness as you enter the room. The darkness embraces you and it is almost suffocating. You are just able to make out that there are two doors in this room.",2);
